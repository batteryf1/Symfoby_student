...
use Univercity\ScheduleBundle\Entity\Groups;
...
//
//        $groups = $em->getRepository('UnivercityScheduleBundle:Groups')->findAll();
//
...
//    }
    ...
    {
        $group = new Groups();
        $form = $this->createForm('Univercity\ScheduleBundle\Form\GroupsType', $group);
    ...
    {
        $deleteForm = $this->createDeleteForm($group);
        $editForm = $this->createForm('Univercity\ScheduleBundle\Form\GroupsType', $group);
