...
use Univercity\ScheduleBundle\Entity\Student;
...
//
//        $students = $em->getRepository('UnivercityScheduleBundle:Student')->findAll();
//
...
//    }
    ...
    {
        $student = new Student();
        $form = $this->createForm('Univercity\ScheduleBundle\Form\StudentType', $student);
    ...
    {
        $deleteForm = $this->createDeleteForm($student);
        $editForm = $this->createForm('Univercity\ScheduleBundle\Form\StudentType', $student);
